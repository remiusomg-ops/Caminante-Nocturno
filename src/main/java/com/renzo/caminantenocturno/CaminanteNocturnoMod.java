...
public class CaminanteNocturnoMod {
    ...
    public static final RegistryObject<EntityType<FrascoExplosivoEntity>> FRASCO_EXPLOSIVO_ENTITY = ENTITY_TYPES.register(
        "frasco_explosivo",
        () -> EntityType.Builder.<FrascoExplosivoEntity>of(FrascoExplosivoEntity::new, MobCategory.MISC)
            .sized(0.25F,0.25F).clientTrackingRange(8).updateInterval(10).build("caminantenocturno:frasco_explosivo")
    );
