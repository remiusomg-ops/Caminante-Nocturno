...
public final class ClientEvents{
 @SubscribeEvent public static void registerRenderers(EntityRenderersEvent.RegisterRenderers e){e.registerEntityRenderer(CaminanteNocturnoMod.CAMINANTE_NOCTURNO.get(),CaminanteNocturnoRenderer::new);}
}
